...
import com.han.my_friend_kim_jung_san.databinding.AddAccountPopupBinding
import com.han.my_friend_kim_jung_san.databinding.AddAcountDialogBaseBinding

class SlideUpDialog(context: Context, builder: Builder) : Dialog(
    context,
    ...
    init {
        ...
        setContentView(R.layout.add_acount_dialog_base)
